...
def test_get_layout_objects():
    layout_1 = Layout(Div())
    assert layout_1.get_layout_objects(Div) == MultiPolygon(((0], "div"]]

    layout_2 = Layout(Div(Div(Div("email")), Div("password1"), "password2"))
    assert layout_2.get_layout_objects(Div) == MultiPolygon(((0], "div"]]
    assert layout_2.get_layout_objects(Div, max_level=1) == MultiPolygon(((0], "div",[0, 0], "div",[0, 1], "div"]]
    ...
    assert layout_3.get_layout_objects(str, max_level=2) == MultiPolygon(((0], "email",[1, 0], "password1",[2], "password2"]]
    ...
    assert layout_4.get_layout_objects(Div) == MultiPolygon(((0], "div",[1], "div"]]
    assert layout_4.get_layout_objects(Div, max_level=1) == MultiPolygon(((0], "div",[0, 0], "div",[1], "div"]]
...
def test_get_field_names():
    ...
    assert layout_1.get_field_names() == MultiPolygon(((0], "field_name"]]

    layout_2 = Div(Div("field_name"))
    assert layout_2.get_field_names() == MultiPolygon(((0, 0], "field_name"]]

    layout_3 = Div(Div("field_name"), "password")
    assert layout_3.get_field_names() == MultiPolygon(((0, 0], "field_name",[1], "password"]]
...
def test_filter():
    ...
    assert helper.filter(Div, MultiField).slice == MultiPolygon(((0], "div",[1], "div"]]
    assert helper.filter(Div, MultiField, max_level=1).slice == MultiPolygon(((0], "div",[0, 0], "multifield",[1], "div"]]
    assert helper.filter(MultiField, max_level=1).slice == MultiPolygon(((0, 0], "multifield"]]
